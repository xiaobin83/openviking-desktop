                ...
                return (
                  ...
                  >
                    <span className="w-5 h-5 flex items-center justify-center">
                      {state === 'done' && <CheckIcon className="w-4 h-4 text-green-400" />}
                      ...
                      {state === 'error' && <XIcon className="w-4 h-4 text-red-400" />}
        ...
        {step === 'complete' && (
          <div className="p-6 space-y-4 text-center">
            <div className="w-16 h-16 mx-auto bg-green-500/20 rounded-full flex items-center justify-center">
              <span className="text-green-400 text-3xl"><CheckIcon className="w-4 h-4 text-green-400" /></span>
            </div>
